<?php
  ...
  if (!isset($_SESSION["id_usuario"])) {
	...
	$query1 = "SELECT * FROM metas WHERE id_usuario='$idusuario' AND anio='2022'";
	...
	if ($row1>0) {
		...
		header("Location:metas2.php?id=$idusuario");
	...
	$sql = "INSERT INTO metas ( id_usuario,meta1,meta2, meta3,meta4,funcion1,funcion2,funcion3,funcion4,funcion5,funcion6,funcion7,rfc_superior,rfc_tercer,anio) VALUES
	 ...
	 ('$idusuario','$meta1','$meta2','$meta3','$meta4','$funcion1','$funcion2','$funcion3','$funcion4',NULL,NULL,NULL,'$rfc_superior','$rfc_tercer','2022')";
 		...
 		<head>
		    ...
		    <div class="container">
				...
				<br>
		   		...
		   		<center><a href="metas0.php"><button class="btn btn-default" > Regresar a Men&uacute; <span  class="glyphicon glyphicon-arrow-left"></button></a>&nbsp;<a href="registro.php"><button class="btn btn-danger" > Salir  <span  class="glyphicon glyphicon-remove"></span></button></a></center>
		   		 </div>
