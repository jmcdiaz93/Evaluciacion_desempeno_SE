...
<div class="container">
  ...
  <form action="borrareva1.php" method="POST">  
  <div class="col-sm-12 col-md-12">
      ...
      <br>
          ...
          $query = "SELECT a.id_usuario, b.apellido_paterno,b.apellido_materno,b.nombre FROM resultados a INNER JOIN usuarios b WHERE a.id_usuario=b.id_usuario AND anio='2021'";
          ...
          if ($resultado =$mysqli->query($query))   
           ...
           <center> <button class="btn btn-danger">Borrar evaluaci&oacute;n</button> </center>
            </form>
